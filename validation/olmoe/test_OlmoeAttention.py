...
from transformers.models.olmoe.modeling_olmoe import OlmoeSdpaAttention, OlmoeRotaryEmbedding

# Optimus imports
from optimus.models.olmoe.configuration_olmoe import OlmoeParallelConfig
from optimus.models.olmoe.modeling_olmoe import OlmoeParallelAttention, OlmoeParallelRotaryEmbedding
...
# HF model
model_hf = OlmoeSdpaAttention(config_hf, layer_idx=0)
# OM model
model = OlmoeParallelAttention(config)
